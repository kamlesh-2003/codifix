<footer id="footer" class="footer position-relative dark-background">
        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6 col-sm-12 footer-about mb-4">
                <a href="./" class="d-flex align-items-center">
                    <span class="sitename">CodiFix</span>
                </a>
    ...
    <div class="container copyright text-center mt-4">
        <p>© <span>Copyright</span> <strong class="px-1 sitename"> <a href="https://codifix.online/"> codifix.online</a></strong> <span>All rights reserved</span></p>
    </div>
